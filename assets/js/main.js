...
//Request a call form
	  $('#requestCallForm').submit(function (event) {
		// we stoped it
	  ...
	  $(".btnRequestCallMenu").click(function (e) {
		e.preventDefault();
		$(".divRequestCall").removeClass("hidden")
  
		if ($(".divRequestCall").is(":hidden")) {
		  $(".divRequestCall").slideDown("slow");
		  $('html, body').animate({
			scrollTop: 0
		  }, '300');
		} else {
